...
`
  ...
  buttons: buttons,
  headerType: 4,
  contextInfo: {"externalAdReply": {title: `Hai ${pushname}`, mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: `${wib}`, thumbnail: global.thumb2, sourceUrl: global.roflix2}}
  }
  xcaa.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
  } catch (err) {
  m.reply(mess.error)
