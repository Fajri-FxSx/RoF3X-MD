...
//Random Buat Fake Online / Offline Dll
  let rdmanu = ['recording','unavailable','available','composing','paused']
  const rdmggbgg = pickRandom(rdmanu)
  ...
  mimetype: `${rdmfil}`,
  fileLength: 99999999,
  contactVcard: true, // note : ini kalo pencet button nya, reply nya bukan document tapi kontak, dan juga kalo klik text auto jadi contact
  jpegThumbnail: global.thumb,
  caption: teks,
  footer: `${rdmaut}`,
  buttons: buttons,
...
//Push Message To Console
  ...
  if (command) {
  await xcaa.sendPresenceUpdate(rdmggbgg, m.chat)
  }
...
case 'restart': {
  ...
  try {
  m.reply(mess.wait)
  exec(`cd RoF3X-MD && npm start`) // Ini Kalo Run Nya Di Termux
...
case 'kisah-nabi': case 'kisahnabi': {
  ...
  rows: [
  {title: "Nabi Adam", rowId: `kisah adam`, description: ``},
  {title: "Nabi Idris", rowId: `kisah idris`, description: ``},
  {title: "Nabi Nuh", rowId: `kisah nuh`, description: ``},
  {title: "Nabi Hud ", rowId: `kisah hud`, description: ``},
  {title: "Nabi Sholeh", rowId: `kisah sholeh`, description: ``},
  {title: "Nabi Ibrahim", rowId: `kisah ibrahim`, description: ``},
  {title: "Nabi Luth", rowId: `kisah luth`, description: ``},
  {title: "Nabi Ismail", rowId: `kisah ismail`, description: ``},
  {title: "Nabi Ishaq", rowId: `kisah ishaq`, description: ``},
  {title: "Nabi Yaqub", rowId: `kisah yaqub`, description: ``},
  {title: "Nabi Yusuf", rowId: `kisah yusuf`, description: ``},
  {title: "Nabi Ayyub", rowId: `kisah ayyub`, description: ``},
  {title: "Nabi Syuaib", rowId: `kisah syuaib`, description: ``},
  {title: "Nabi Musa", rowId: `kisah musa`, description: ``},
  {title: "Nabi Harun", rowId: `kisah harun`, description: ``},
  {title: "Nabi Dzulkifli", rowId: `kisah dzulkifli`, description: ``},
  {title: "Nabi Daud", rowId: `kisah daud`, description: ``},
  {title: "Nabi Sulaiman", rowId: `kisah sulaiman`, description: ``},
  {title: "Nabi Ilyas", rowId: `kisah ilyas`, description: ``},
  {title: "Nabi Ilyasa", rowId: `kisah ilyasa`, description: ``},
  {title: "Nabi Yunus", rowId: `kisah yunus`, description: ``},
  {title: "Nabi Zakariya", rowId: `kisah zakariya`, description: ``},
  {title: "Nabi Yahya", rowId: `kisah yahya`, description: ``},
  {title: "Nabi Isa", rowId: `kisah isa`, description: ``},
  {title: "Nabi Muhammad", rowId: `kisah muhammad`, description: ``}
  ]
  },
  ]
...
case 'kisah': {
  ...
  try {
  result = JSON.parse(fs.readFileSync(`./lib/kisahNabi/${args[0]}.json`));
  bufft = await getBuffer(result.image_url)
  xcaa.sendMessage(m.chat, {image: bufft, caption: `*Name* : ${result.name}\n*Kelahiran* : ${result.thn_kelahiran}\n*Usia* : ${result.usia}\n*Tempat* : ${result.tmp}\n*Description* : ${result.description}`}, {quoted: m})
  } catch (err) {
  reply2(from)
  }
  }
