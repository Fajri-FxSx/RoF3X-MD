...
case 'tiktok': case 'tiktoknowm': case 'ttnowm': case 'tiktokvideo': case 'ttvideo': {
  ...
  xcaa.sendMessage(from, { video: { url: musim_duren_v }, caption: global.mess.sukses }, { quoted: m })
  }
  break
case 'tiktokaudio': case 'tiktokmusic': case 'ttaudio': case 'ttkaudio': case 'ttmusik': {
  ...
  xcaa.sendMessage(from, { audio: { url: musim_duren_a }, mimetype: 'audio/mp4' }, { quoted: m })
  }
  break
//Tools
case 'get': {
