...
//Fake Reply
  const ftroli = {key: {fromMe: true, participant: `${m.sender.split('@')[0]}s.whatsapp.net`, ...(m.chat ? { remoteJid: "120363025016778449@g.us" } : {}) }, message: {"orderMessage": {"orderId": "174238614569481", "thumbnail": global.thumb2, "itemCount": 1, "status": "INQUIRY", "surface": "CATALOG", "message": `Hai ${pushname}`, "token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}
...
`
  ...
  buttons: buttons,
  headerType: 4,
  contextInfo:{externalAdReply: {renderLargerThumbnail: false, showAdAttribution: true, title: `Hai ${pushname}`, body: `${wib}`, previewType: "PHOTO", thumbnailUrl: ``, thumbnail: global.thumb2, sourceUrl: global.linkgc}}
  }
...
`
  ...
  buttons: buttons,
  headerType: 4,
  contextInfo:{externalAdReply: {showAdAttribution: true, renderLargerThumbnail: true, title: `Hai ${pushname}`, body: `${wib}`, previewType: "PHOTO", thumbnailUrl: ``, thumbnail: global.thumb2, sourceUrl: global.roflix2}}
  }
  xcaa.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
  } catch (err) {
  m.reply(mess.error)
