...
//Random File
  ...
  buttons: buttons,
  headerType: 4,
  contextInfo:{"externalAdReply":{"title": `Hai ${pushname} 👋🏻`,"body": `${wib}`, "mediaType": 1, "thumbnailUrl": 'https://i.ibb.co/nz183Cv/imgnya2.png', "thumbnail": global.thumb2,"sourceUrl": global.linkgc, containsAutoReply: true, showAdAttribution: true, renderLargerThumbnail: true}}
  }
  ...
  let template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
  "groupInviteMessage": {
  "groupJid": '120363025016778449@g.us',
  "inviteCode": global.linkgc,
  "groupName": `${rdmpck}`,
  "footerText": `${rdmaut}`,
...
`
  ...
  buttons: buttons,
  headerType: 4,
  contextInfo: {externalAdReply: {title: `Hai ${pushname}`, body: `${wib}`, previewType: 1, thumbnail: global.thumb2, sourceUrl: global.linkgc, showAdAttribution: true, containsAutoReply: true, renderLargerThumbnail: true}}
  }
  xcaa.sendMessage(m.chat, buttonMessage, { quoted: rdmtrol })
  } catch (err) {
  reply2(from)
...
case 'linkgc2': case 'linkgrup2': {
  ...
  break
case 'linkgc3': case 'linkgrup2': {
  try {
  let response = await xcaa.groupInviteCode(m.chat)
  let btnn = [
     {actionLink: {buttonTitle: 'Salin', url: `https://chat.whatsapp.com/${response}`}},
     {urlButton: {displayText: 'Website', url: global.roflix2}},
...
case 'ytmp3': case 'ytaudio': {
  ...
  xcaa.sendMessage(m.chat, {audio: {url: media.dl_link}, mimetype: "audio/mpeg", fileName: `${media.title}.mp3`, contextInfo: {externalAdReply: {title: `${media.title}`, body: `${media.filesizeF}`, previewType: 1, thumbnailUrl: `${media.thumb}`, thumbnail: `${media.thumb}`, sourceUrl: `${isUrl(text)}`, showAdAttribution: true, renderLargerThumbnail: true}}}, { quoted: m })
  } catch (err) {
  reply2(from)
  }
  }
