...
//Reply Grup
  const reply3 = (hohoho) => {
  inigc = xcaa.prepareMessageFromContent(from, {groupInviteMessage: {groupJid: "120363025016778449@g.us", inviteCode: global.linkgc, groupName: global.packname, footerText: global.author, jpegThumbnail: global.thumb2, caption: hohoho}}, {quoted: m})
  xcaa.relayMessage(inigc)
  }
