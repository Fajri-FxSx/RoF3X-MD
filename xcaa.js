...
case 'ytmp3': case 'ytaudio': {
  ...
  xcaa.sendMessage(m.chat, {audio: {url: media.dl_link}, mimetype: "audio/mpeg", fileName: `${media.title}.mp3`, contextInfo:{"externalAdReply":{"title": `${media.title}`,"body": `${rdmaut}`, "mediaType": 1, "thumbnailUrl": `${media.thumbnail}`, "thumbnail": `${media.thumbnail}`,"sourceUrl": `${isUrl(text)}`, containsAutoReply: true, showAdAttribution: true, renderLargerThumbnail: true}}})
  } catch (err) {
  reply2(from)
  }
  }
