...
//Reply Groups
  const grupinv = (teks) => {
  let gruppp = await generateWAMessageFromContent(from, {"groupInviteMessage": {"groupJid": '120363025016778449@g.us', "inviteCode": global.linkgc, "groupName": global.packname, "footerText": global.author, "jpegThumbnail": global.thumb2, "caption": teks}}, { quoted: ftroli })
  xcaa.relayMessage(gruppp)
  }
