...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: global.weel, ptt: true, duration: 9999900000, contextInfo: { mentionedJid: [num], mimetype: "audio/mp4", externalAdReply: {showAdAttribution: true, containsAutoReply: true, title: teks1, body: `${ddate}`, previewType: "PHOTO", thumbnailUrl: bufft, thumbnail: bufft, sourceUrl: global.linkgc}}})
    ...
    xcaa.public = false // di true in auto public kalo di false auto self
