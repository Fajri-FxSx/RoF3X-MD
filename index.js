...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: global.weel, mimetype: "audio/mp4", ptt: true, contextInfo:{mentionedJid: [num], "externalAdReply":{"title": teks1,"body": `To ${metadata.subject}`, "mediaType": 1, "thumbnailUrl": ppuser, "thumbnail": bufft,"sourceUrl": global.linkgc, containsAutoReply: true, showAdAttribution: true, renderLargerThumbnail: true}}})
    } else if (anu.action == 'remove') {
    let lvbuft = await getBuffer(ppuser)
    teks2 = `Sayonara @${num.split("@")[0]} 👋`
    xcaa.sendMessage(anu.id, {audio: global.beey, mimetype: "audio/mp4", ptt: true, contextInfo:{mentionedJid: [num], "externalAdReply":{"title": teks2,"body": `To ${metadata.subject}`, "mediaType": 1, "thumbnailUrl": ppuser, "thumbnail": lvbuft,"sourceUrl": global.linkgc, containsAutoReply: true, showAdAttribution: true, renderLargerThumbnail: true}}})
